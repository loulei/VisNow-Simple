...
/**
 * Dispatches messages (UserMessages) to registered listeners.
 * @author szpak
 */
public class UserMessageDispatcher {
    private List<UserMessageListener> listeners = new ArrayList<UserMessageListener>();
    
    public void addListener(UserMessageListener messageListener) {
