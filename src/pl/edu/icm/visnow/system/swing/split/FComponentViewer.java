 ...
 * @author gacek
 */
public class FComponentViewer extends javax.swing.JFrame {


    public FComponentViewer(Component component, String title, int x, int y, boolean resizable, int closeOperation) {
