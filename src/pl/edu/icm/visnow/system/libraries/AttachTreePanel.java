 ...
 * @author babor
 */
//public class AttachTreePanel extends javax.swing.JPanel {
public class AttachTreePanel extends javax.swing.JMenuItem {

    private PortPanel panel = null;

    /**
     * Creates new form TreePanel
     */
    public AttachTreePanel(DefaultTreeModel model, PortPanel panel) {
        initComponents();
        this.panel = panel;
        ...
        tree.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
                    final DefaultMutableTreeNode ptn = (DefaultMutableTreeNode) tn.getParent();
                    if (ptn == null) {
                        return;
                    }
                    ...
                    SwingInstancer.swingRunAndWait(new Runnable() {
                        ...
                        public void run() {
                            if (tn.isLeaf() && ptn.getUserObject() instanceof LibraryCore) {
                                    VisNow.get().getAttachWizard().portChosen((LibraryCore) ptn.getUserObject(), tn.toString());
                            }
                            if (tn.getUserObject() instanceof LibraryCore) {
                                LibraryCore lc = (LibraryCore) tn.getUserObject();
                                VisNow.get().getAttachWizard().portChosen(lc, tn.getFirstChild().toString());
                            }
