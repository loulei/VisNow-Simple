...
public class DataArraySchema implements Serializable
{
   ...
   /**
    * Return name of the schema; by default name is an empty string.
    */
   ...
   /**
    * Return true if schema is of numeric type, but not including complex type:
   ...
   /**
    * Return true if schema is of any numeric type:
    * byte, short, int, float, double, complex.
    */
   public boolean isNumeric()
   {
      return isSimpleNumeric() || type == DataArray.FIELD_DATA_COMPLEX;
   }
