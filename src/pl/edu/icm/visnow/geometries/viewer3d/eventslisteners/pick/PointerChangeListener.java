...
/**
 * Implemented by objects that want to get information about change of an active device pointer.
 * <p/>
 * NOTE: Currently implemented only by {@link PickObject}.
 * <p/>
...
public interface PointerChangeListener {
    ...
    /**
     * Called when there was a change in active device pointer.
     * <p/>
     * @param newPointer3D pointer object that became an active pointer or <code>null</code> if the
     *                     pointer was just disabled
     */
