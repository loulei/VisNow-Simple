...
public class TextureComponentPanel extends javax.swing.JPanel
{
   ...
   private void initComponents()
   {
      ...
      setMinimumSize(new java.awt.Dimension(160, 138));
      setPreferredSize(new java.awt.Dimension(210, 140));
      setLayout(new java.awt.BorderLayout());

      compSelector.setBorder(null);
      compSelector.setMinimumSize(new java.awt.Dimension(150, 30));
      compSelector.setName("compSelector"); // NOI18N
      compSelector.setPreferredSize(new java.awt.Dimension(200, 35));
