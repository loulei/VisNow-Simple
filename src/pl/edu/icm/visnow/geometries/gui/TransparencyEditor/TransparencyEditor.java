...
public class TransparencyEditor extends javax.swing.JPanel implements Serializable
{
   ...
   public TransparencyEditor()
   {
      ...
      dataComponentSelector.setStartNullTransparencyComponent(true);
      for (int i = 0; i < 256; i++)
         transp[i] = .0039f * i;
   ...
   private void initComponents()
   {
      ...
      setMinimumSize(new java.awt.Dimension(150, 260));
      setOpaque(false);
      ...
      transpRangeSlider.setPreferredSize(new java.awt.Dimension(216, 64));
      ...
      dataComponentSelector.setMinimumSize(new java.awt.Dimension(100, 36));
      dataComponentSelector.setOpaque(true);
      dataComponentSelector.setPreferredSize(new java.awt.Dimension(150, 36));
      ...
      jPanel2.setPreferredSize(new java.awt.Dimension(240, 75));
...
private void minusAbsXResetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_minusAbsXResetButtonActionPerformed
   ...
   public void setDataRange(float dmin, float dmax)
   {
      low = min = dmin;
      up = max = dmax;
      transpRangeSlider.setParams(min, low, up, max);
      histogramGraphPanel.setMinMax(low, up);
      histogramGraphPanel.repaint();
   }
   ...
   {
      dataComponentSelector.setStartNullTransparencyComponent(startNull);
   }
