...
import pl.edu.icm.visnow.gui.widgets.UnboundedRoller.DefaultUnboundedIntValueModel;
import pl.edu.icm.visnow.gui.widgets.UnboundedRoller.UnboundedIntValueModel;
...
public class UnboundedIntRoller extends JComponent implements ChangeListener, Serializable
{
   ...
   {
      setModel(m);
      setMinimumSize(new Dimension(45, 60));
