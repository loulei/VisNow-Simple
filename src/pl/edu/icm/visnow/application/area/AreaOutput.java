...
public class AreaOutput {
    ...
    public void deleteModule(String name, CoreName coreName, Point location) {
        this.getArea()
                .getApplication()
                .getReceiver()
    ...
    public void renameModule(String name, String jop) {
        this.getArea()
                .getApplication()
                .getReceiver()
    ...
    public void deleteLink(final LinkName name) {
        new Thread(new Runnable() {public void run() {
            getArea().getApplication().getReceiver().receive(new LinkDeleteCommand(name));
        }}).start();
    }
}
