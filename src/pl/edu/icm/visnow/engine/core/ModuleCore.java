...
/**
 * This class describes module instance from the user's point of view. It is a template to be filled
 * by the author of a module and provides most of the methods that author will need. <br><br>
 * <b>IMPORTANT FUNCTIONS:</b><br> <a href="#setProgress(float)">setProgress(float progress)</a><br>
...
public abstract class ModuleCore extends VolatileModuleCore
{
   ...
   //--------------------------------------------------------------------------
   /**
     * Returns first data object found on the input.
     * This method doesn't guarantee any particular order.
     * @param name Name of the input.
     * @return One of data objects present on the input.
     * Null if the input is unlinked.
     */
   ...
   /**
     * Returns first value found on the input.
     * This method doesn't guarantee any particular order.
     * @param name Name of the input.
     * @return Some of values found on the input.
     * If the port is unlinked, this method returns the default value.
     */
   ...
   /**
     ...
     * @param name Name of the input.
     * @return Vector of all present data objects.
     * If the input is unlinked, it is empty.
     */
   ...
   //--------------------------------------------------------------------------
   /**
     * Sets the value on given output and mark it as fresh.
     * Object class must be accepted by the port.
     * @param name Name of the output.
     * @param value Value to be set.
     * @return True if the value was correctly set.
     * If any error occured (i.eggs. the object class was incorrect)
   ...
   //--------------------------------------------------------------------------
   /**
    * Float value in [0,1] representing progress level of module action. 0 is begining, 1 is the
    * end.
    */
   ...
   /**
     ...
     * the computation should be stopped immediatelly.</span>
     * @see #isAllowed()
     */
   ...
   /**
     * The metod checks whether the computation was not cancelled.
     * Since Java currently doesn't support thread stopping,
     * this method should be invoked frequently
     * (especially in heavy modules) to check whether the computation
     * was not interrupted.
     * @return <span style="color: #ffffff; font-weight: bold;">
     * If this method returns false,
     * the computation should be stopped immediatelly.</span>
   ...
   /**
     * Returns lightweight object sufficient to store and load instance
     * of current module. Doesn't store module name nor it's parameters.
   ...
   //--------------------------------------------------------------------------
   //</editor-fold>
   //<editor-fold defaultstate="collapsed" desc=" [VAR] UI ">
   //--------------------------------------------------------------------------
...
//     *
//     */
//    private ModuleUI moduleUI = null;
//
//    /**
//     *
//     * @param modUI
//     */
//    public void addModuleUI(JPanel modUI) {
//        if(moduleUI == null)  moduleUI = new ModuleUI();
//        moduleUI.addModuleUI( modUI);
//    }
//
//    /**
//     *
...
//    }
   ...
   //--------------------------------------------------------------------------
   /**
     * Event invoked when the new computation wave is starting
     * in the current module. Currently not implemented.
     */
   ...
   /**
     * Event invoked when the computation wave started in the current module
     * is finished. Currently not implemented.
     */
   ...
   /**
     * Event invoked when new message is received by the engine element
     * of the module. Currently not implemented.
   ...
   /**
     * Event invoked when the deactivated computation wave reaches current module.
     * Should be overriden when some preparations were made during the notifying
     * phase that should be cleaned up.
   ...
   //--------------------------------------------------------------------------
   /**
     * Event invoked when the construction of the module was finished.
     * Any element of the core constructor that uses internal module elements
     * and therefore leads to errors when invoked too early may be safely
     * transferred to this method and then invoked properly.
     */
   ...
   /**
     * Event invoked when deleting module.
     * It is called after all of the links to the module, but before
     * the module itself is removed from the engine. All necessary cleanups
     * and garbage collecting should be preformed here.
     */
   ...
   //--------------------------------------------------------------------------
   /**
     * Method used to manually start action in current module.
     * Could be invoked <b>once</b> after parameters change.
     */
   ...
   /**
     * Method used to indicate an error in calculations
     * and necessity to stop the whole current wave.
     * Not yet implemented.
     */
   ...
   /**
     ...
     * Module calculations and setting output value should be performed here.
     * Invoked when the active wave reaches the module.
     *
     * @see Object TODO - engine description
     */
   ...
   //--------------------------------------------------------------------------
   /**
     * Method used to initialize inputs of the module.
     * By default, it creates inputs from the given eggs.
     */
...
//        try {
//            inputEggs = (InputEgg[])this.getClass().getMethod("getInputEggs").invoke(this);
//        } catch (NoSuchMethodException ex) {
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
...
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        this.inputs = new Inputs(inputEggs);//, this.getModuleBoxEgg());

//        InputEgg[] inputEggs = null;
//        try {
//            //try read from module.xml
//            inputEggs = ModuleXMLReader.getInputEggsFromModuleXML(this.getClass().getPackage().getName());
//
//            if(inputEggs == null) {
//                //try from static method
//                inputEggs = (InputEgg[])this.getClass().getMethod("getInputEggs").invoke(this);
//            }
...
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        this.inputs = new Inputs(inputEggs);

      this.inputs = new Inputs(ModuleCore.getInputEggs(this.getClass().getName()));

   }

   /**
     * Method used to initialize outputs of the module.
     * By default, it creates outputs from the given eggs.
     */
   @SuppressWarnings("unchecked")
...
//        try {
//            outputEggs = (OutputEgg[])this.getClass().getMethod("getOutputEggs").invoke(this);
//        } catch (NoSuchMethodException ex) {
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
//        } catch (SecurityException ex) {
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
...
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        this.outputs = new Outputs(outputEggs);//, this.getModuleBoxEgg());

//        OutputEgg[] outputEggs = null;
//        try {
//            //try read from module.xml
//            outputEggs = ModuleXMLReader.getOutputEggsFromModuleXML(this.getClass().getPackage().getName());
//
//            if(outputEggs == null) {
//                //try from static method
//                outputEggs = (OutputEgg[])this.getClass().getMethod("getputEggs").invoke(this);
//            }
//        } catch(ClassNotFoundException ex) {
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
//        } catch(IOException ex) {
...
//            Logger.getLogger(ModuleCore.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        this.outputs = new Outputs(outputEggs);

      this.outputs = new Outputs(ModuleCore.getOutputEggs(this.getClass().getName()));
   }

   /**
     * Method used to initialize parameters of the module.
     * By default, it creates parameters from the given eggs.
     */
   @SuppressWarnings("unchecked")
   ...
   /**
     * Method used to initialize ports of the module.
     * By default, it initializes inputs, outputs and parameters.
     */
   ...
   /**
     * Static method that gives the information about the parameters of the module.
   ...
   //--------------------------------------------------------------------------
   /**
     * Method used to check if the module is ready to perform calculations.
     * All the non-standard conditions on the input state (such as dimension
     * of the input value) should be verified here.
     * By default it allows performing action (returns true).
   ...
   /**
     * Checks whether the current module is a generator.
     * Precisely, if it is possible to start a valid action tree from this module,
     * it should be marked by overriding this function to return true.
     * Particularly, this should be performed in all the modules like
     * readers, test objects, sample generators etc.
     * @return True, if it is possible to start a valid action tree from this module.
     */
   ...
   /**
     * Checks whether the current module is a viewer.
     * Precisely, if it is possible to sensibely finish an action tree
     * with this module. This applies for all viewers, loggers, export modules etc.
   ...
   //--------------------------------------------------------------------------
   //</editor-fold>
   public static InputEgg[] getInputEggs(String classname)
   {
       if(classname == null)
           return null;
      ...
      try
      {
         ...
         if (e == null)
         {
            ...
            e = ModuleXMLReader.getInputEggsFromModuleXML(moduleClass.getPackage().getName());
            if (e != null)
            {
   ...
   public static OutputEgg[] getOutputEggs(String classname)
   {
      Class moduleClass = null;
      try
      {
      ...
      try
      {
         ...
         if (eggs == null)
         {
            ...
            eggs = ModuleXMLReader.getOutputEggsFromModuleXML(moduleClass.getPackage().getName());
            if (eggs != null)
            {
