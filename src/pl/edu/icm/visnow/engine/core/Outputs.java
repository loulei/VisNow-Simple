...
public class Outputs implements Iterable<Output> {
    ...
    public Outputs(OutputEgg[] eggs){//, ModuleBox module) {
    ...
    public HashMap<String, Output> getOutputs() {return outputs;}
    public Vector<Output> getSortedOutputs() {return sorted;}
    public Output getOutput(String name) {return outputs.get(name);}
