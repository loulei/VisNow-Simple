...
public abstract class Entry implements ChangeListener {
    ...
    public static final int ENTRY_TYPE_TOOL = 3;
    public static final int ENTRY_TYPE_CPOINT = 2;
    public static final int ENTRY_TYPE_BRANCH = 1;
    public static final int ENTRY_TYPE_ROOT = 0;

    protected int type = ENTRY_TYPE_ROOT;
    protected String id;
