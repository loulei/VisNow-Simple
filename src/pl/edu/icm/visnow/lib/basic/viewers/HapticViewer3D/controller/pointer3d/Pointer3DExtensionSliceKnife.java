 ...
 * <p/>
 * It shows a square depicting a plain which will be picked. The square is parallel to the arrow's
 * shaft.
 * <p/>
 * @author Łukasz Czerwiński <czerwinskilukasz1 [#] gmail.com>, ICM, University of Warsaw, 2013
 */
public class Pointer3DExtensionSliceKnife extends Pointer3DExtensionSlice {

    public Pointer3DExtensionSliceKnife(float baseWidth) {
        super(baseWidth, true);
    }
}
