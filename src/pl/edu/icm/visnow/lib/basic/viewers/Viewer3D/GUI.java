...
public class GUI extends javax.swing.JPanel
{
    ...
    */
    ...
    private void initComponents() {
        ...
        detachToggle = new javax.swing.JToggleButton();
        ...
        detachToggle.setSelected(true);
        detachToggle.setText("<html>dock/undock<p>controls</html>");
        detachToggle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                detachToggleActionPerformed(evt);
            }
        });
        jPanel2.add(detachToggle);
   ...
   private void detachToggleActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_detachToggleActionPerformed
   {//GEN-HEADEREND:event_detachToggleActionPerformed
      if (detachToggle.isSelected())
      {
         ...
         controlsContainer.remove(controlsPanel);
         revalidate();
      ...
      } else
      {
         ...
         detachedFrame.remove(controlsPanel);
         detachedFrame = null;
         controlsContainer.add(controlsPanel, java.awt.BorderLayout.CENTER);
         revalidate();
      } 
      viewerModule.setTransientControlsFrame(detachedFrame);
   }//GEN-LAST:event_detachToggleActionPerformed
   ...
   public void setViewerModule(Viewer3D viewerModule)
   {
    ...
    private javax.swing.JToggleButton detachToggle;
