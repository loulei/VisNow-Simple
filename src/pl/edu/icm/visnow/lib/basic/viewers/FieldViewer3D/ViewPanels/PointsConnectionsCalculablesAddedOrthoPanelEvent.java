 ...
 * @author vis
 */
public class PointsConnectionsCalculablesAddedOrthoPanelEvent extends ViewPanelEvent {
    private int[][] points = null;
    private int[][] connections = null;
    private CalculableParameter calculable = null;

    public PointsConnectionsCalculablesAddedOrthoPanelEvent(Object source, int[][] points, int[][] connections, CalculableParameter calculable) {
        super(source);
        if(points != null) {
            int n = points.length;
