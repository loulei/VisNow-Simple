 ...
 * @author vis
 */
public class GeometryPointMovedCustomOrthoPanelEvent extends ViewPanelEvent {
    private int pointNumber = -1;
    private float[] point = new float[3];

    public GeometryPointMovedCustomOrthoPanelEvent(Object source, int pointNumber, float[] point) {
        super(source);
