...
public class NewCalculableParams {

    private CalculableParamsPool.CalculableType type = null;
    private String name = "";
     ...
     * @return the type
     */
    public CalculableParamsPool.CalculableType getType() {
        return type;
    }
     ...
     */
    public void setType(CalculableParamsPool.CalculableType type) {
        this.type = type;
        fireStateChanged();
    }
    ...
    public void setParametersString(String parameters) {
        this.parameterString = parameters;
    }
