 ...
 * @author babor
 */
public class NewCalculablePointDialog extends javax.swing.JDialog {
    private NewCalculablePointParams params = new NewCalculablePointParams();
    ...
    public NewCalculablePointDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        params.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if(params.getType() != null && params.getName() != null && params.getName().length() > 0 && params.getPoints().size() > 1) {
                    CalculablePoint tmpcp = CalculablePointsPool.getCalculablePoint(params.getType(), params.getName());
    ...
    private void updateCalculablePointsList() {
        typeCB.setModel(new DefaultComboBoxModel(CalculablePointsPool.CalculablePointType.values()));
    }
    ...
    private void initComponents() {
        ...
        infoLabel.setText("Fill all required parameters of a new calculated point");
        ...
        jLabel1.setText("Select calculated point type:");
        ...
        jLabel2.setText("Enter calculated point name:");
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        this.cp = CalculablePointsPool.getCalculablePoint(params.getType(), params.getName());
    ...
    private void typeCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_typeCBActionPerformed
        //System.out.println("selected: "+typeCB.getSelectedItem()+" class:"+typeCB.getSelectedItem().getClass());
        params.setType((CalculablePointsPool.CalculablePointType)typeCB.getSelectedItem());
     ...
     * @return the cp
     */
    public CalculablePoint getNewCalculablePoint() {
        return cp;
    }
