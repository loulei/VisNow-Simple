...
public class GUI extends javax.swing.JPanel
{
   ...
   @SuppressWarnings("unchecked")
    ...
    {//GEN-HEADEREND:event_writeButtonActionPerformed
       if (params.getFileName() != null && params.getFileName().length() > 4 && VNFileChooser.checkForOverwrite( path ))
       {
          params.fireStateChanged();
       }
    ...
    {//GEN-HEADEREND:event_selectButtonActionPerformed
       if (lastPath == null)
		...
		FileNameExtensionFilter objExtensionFilter = new FileNameExtensionFilter("Wavefront OBJ", "obj", "OBJ");
       fileChooser.setFileFilter(objExtensionFilter);


       int returnVal = fileChooser.showDialog(this, "Select");
       if (returnVal == JFileChooser.APPROVE_OPTION)
       {
          path = VNFileChooser.filenameWithExtenstionAddedIfNecessary(fileChooser.getSelectedFile(),objExtensionFilter);
