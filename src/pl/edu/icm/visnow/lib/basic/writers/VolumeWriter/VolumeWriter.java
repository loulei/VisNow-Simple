...
package pl.edu.icm.visnow.lib.basic.writers.VolumeWriter;
...
import pl.edu.icm.visnow.lib.utils.io.FieldWriter;
 ...
 */
public class VolumeWriter extends ModuleCore
{
   ...
   public VolumeWriter()
   {
      ...
      params.addChangeListener(new ChangeListener()
      {
         ...
         {
            FieldWriter.writeVolume(params.getFileName(), inField);
         }
      });
