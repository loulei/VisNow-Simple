...
public class OBJWriter extends FilterWriter {
   ...
   */
  private int getNormalIndex(IndexedGeometryArray geometryArray, int vertexIndex)
  {
     if (geometryArray.getCapability(GeometryArray.USE_COORD_INDEX_ONLY))
        return geometryArray.getCoordinateIndex(vertexIndex);
     else
        return getNormalIndex(geometryArray, vertexIndex);
  }

  private int getTextureIndex(IndexedGeometryArray geometryArray, int off, int vertexIndex)
  {
     if (geometryArray.getCapability(GeometryArray.USE_COORD_INDEX_ONLY))
        return geometryArray.getCoordinateIndex(vertexIndex);
     else
        return getTextureIndex(geometryArray, off, vertexIndex);
  }
    ...
    if ((geometryArray.getVertexFormat() & GeometryArray.TEXTURE_COORDINATE_2) != 0) {
      if ((geometryArray.getVertexFormat() & GeometryArray.NORMALS) != 0) {
        this.out.write("f " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex1)])
            + "/" + (this.textureCoordinatesOffset + textureCoordinatesIndexSubstitutes [getTextureIndex(geometryArray, 0, vertexIndex1)])
            + "/" + (this.normalOffset + normalIndexSubstitutes [getNormalIndex(geometryArray, vertexIndex1)])
            + " " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex2)])
            + "/" + (this.textureCoordinatesOffset + textureCoordinatesIndexSubstitutes [getTextureIndex(geometryArray, 0, vertexIndex2)])
            + "/" + (this.normalOffset + normalIndexSubstitutes [getNormalIndex(geometryArray, vertexIndex2)])
            + " " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex3)])
            + "/" + (this.textureCoordinatesOffset + textureCoordinatesIndexSubstitutes [getTextureIndex(geometryArray, 0, vertexIndex3)])
            + "/" + (this.normalOffset + normalIndexSubstitutes [getNormalIndex(geometryArray, vertexIndex3)]) + "\n");
      } else {
        this.out.write("f " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex1)])
            + "/" + (this.textureCoordinatesOffset + textureCoordinatesIndexSubstitutes [getTextureIndex(geometryArray, 0, vertexIndex1)])
            + " " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex2)])
    ...
    if ((geometryArray.getVertexFormat() & GeometryArray.TEXTURE_COORDINATE_2) != 0) {
      if ((geometryArray.getVertexFormat() & GeometryArray.NORMALS) != 0) {
        this.out.write("f " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex1)])
            ...
            + "/" + (this.textureCoordinatesOffset + textureCoordinatesIndexSubstitutes [getTextureIndex(geometryArray, 0, vertexIndex4)])
            + "/" + (this.normalOffset + normalIndexSubstitutes [getNormalIndex(geometryArray, vertexIndex4)]) + "\n");
      } else {
        this.out.write("f " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex1)])
            + "/" + (this.textureCoordinatesOffset + textureCoordinatesIndexSubstitutes [getTextureIndex(geometryArray, 0, vertexIndex1)])
            + " " + (this.vertexOffset + vertexIndexSubstitutes [geometryArray.getCoordinateIndex(vertexIndex2)])
