 ...
 */
public class CropDownParams extends Parameters
{
   ...
   private static ParameterEgg[] eggs = new ParameterEgg[]
   {
      ...
      new ParameterEgg<int[]>("up", ParameterType.dependent, null),
      new ParameterEgg<int[]>("low", ParameterType.dependent, null)
   };

   public CropDownParams()
   {
      super(eggs);
      setDownsize(new int[]{2, 2, 2});
      setUp(new int[]{1, 1, 1});
      setLow(new int[]{0, 0, 0});      
   }
