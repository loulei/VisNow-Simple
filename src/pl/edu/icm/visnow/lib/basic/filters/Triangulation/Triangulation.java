...
package pl.edu.icm.visnow.lib.basic.filters.Triangulation;
 ...
 */
public class Triangulation extends IrregularOutFieldVisualizationModule
{
   ...
   public void onActive()
   {
      if (getInputFirstValue("inField") == null || ((VNField) getInputFirstValue("inField")).getField() == null)
         return;
      outField = ((VNField)getInputFirstValue("inField")).getField().triangulate();
