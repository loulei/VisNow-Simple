...
public class GUI extends javax.swing.JPanel {
   ...
   public void setParams(Params params)
   {
    ...
    public GUI() {
        initComponents();
        dataComponentList.setTitle("interpolate components");
        updateActiveWidgets();
    }
   ...
   private void initComponents() {
      ...
      cellLabel.setFont(new java.awt.Font("Dialog", 0, 12));
      cellLabel.setText("(current size =                          )");
      gridBagConstraints = new java.awt.GridBagConstraints();
      gridBagConstraints.gridx = 0;
      ...
      dimsLabel.setFont(new java.awt.Font("Dialog", 0, 12));
      ...
      jLabel2.setMinimumSize(new java.awt.Dimension(8, 15));
    ...
    {//GEN-HEADEREND:event_runButtonActionPerformed
       ...
       try
       {
          int[] dims = new int[] {(Integer)dims0Spinner.getValue(),(Integer)dims1Spinner.getValue(),(Integer)dims2Spinner.getValue()};
    ...
    private void updateActiveWidgets()
    {
       ...
       dims1Spinner.setEnabled(dimsButton.isSelected());
       dims2Spinner.setEnabled(dimsButton.isSelected());
    ...
    public void setField(RegularField inField)
    {
       ...
       b.append("(current ");b.append(inField.getDims()[0]);
       if (inField.getDims().length > 1)
       {
             b.append("x");
             b.append(inField.getDims()[1]);
       }
       if (inField.getDims().length > 2)
       {
             b.append("x");  
             b.append(inField.getDims()[2]);
       }
       b.append(")");
       dimsLabel.setText(b.toString());
       if (inField.getCoords() == null)
       {
          cellButton.setEnabled(true);
          b = new StringBuilder();
          b.append(("(current: "));
          b.append(String.format("%7.4f", inField.getAffine()[0][0]));
          if (inField.getDims().length > 1)
          {
             b.append("x");
             b.append(String.format("%7.4f", inField.getAffine()[1][1]));
          }
          if (inField.getDims().length > 2)
          {
             b.append("x");
             b.append(String.format("%7.4f", inField.getAffine()[2][2]));
          }
          b.append(")");
          cellLabel.setText(b.toString());
       }

       cellButton.setEnabled(inField.getCoords() == null);
       dims1Spinner.setEnabled(inField.getDims().length > 1);
       dims2Spinner.setEnabled(inField.getDims().length > 2);
    }
