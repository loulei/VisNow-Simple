...
public class Params extends Parameters {
    ...
    private static ParameterEgg[] eggs = new ParameterEgg[]{
        new ParameterEgg<Integer>("nThreads", ParameterType.independent, 1),
        new ParameterEgg<Integer>("direction", ParameterType.independent, DIRECTION_FORWARD),
        new ParameterEgg<Integer>("origin", ParameterType.independent, ORIGIN_CENTER),
    };
    ...
    public int getOrigin() {
        return (Integer) getValue("origin");
    }
