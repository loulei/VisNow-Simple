 ...
 * @author babor
 */
public class ScalarDataChunk {

    private int subsectionId;
    private int zoneId;
    private double[] scalarData;
    
    public ScalarDataChunk() {
    ...
    /**
     * @return the scalarData
     */
    public double[] getScalarData() {
        return scalarData;
    }
    
    public void setScalarData(double[] d) {
        scalarData = d;
    }
