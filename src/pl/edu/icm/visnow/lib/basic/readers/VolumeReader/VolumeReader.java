...
import pl.edu.icm.visnow.lib.utils.io.RegularFieldReader;
   ...
   public void onActive()
   {
      ...
      switch (params.getSource())
      {
         case InputSource.FILE:
            outField = RegularFieldReader.readVolume(params.getFileName(), params.getType(), params.getOrig(), params.getScale());
            break;
         case InputSource.URL:
            outField = RegularFieldReader.readVolumefromURL(params.getFileName(), params.getType(), params.getOrig(), params.getScale());
            break;
