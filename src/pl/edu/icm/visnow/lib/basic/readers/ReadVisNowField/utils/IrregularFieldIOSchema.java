...
import pl.edu.icm.visnow.lib.basic.readers.ReadVisNowField.utils.CellSetIOSchema;
 ...
 */
public class IrregularFieldIOSchema extends FieldIOSchema
{
   protected IrregularField irregularField;
   

   public IrregularFieldIOSchema(IrregularField field, File f, String url)
   {
      super(field, f, url);
      irregularField = field;
   }

   protected Map<String, CellSetIOSchema> cellSetSchemas = new HashMap<String, CellSetIOSchema>();
