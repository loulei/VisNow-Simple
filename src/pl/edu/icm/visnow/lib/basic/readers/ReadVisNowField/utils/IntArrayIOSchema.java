 ...
 */
public class IntArrayIOSchema extends DataElementIOSchema
{
   private final int[] intArray;

   public IntArrayIOSchema(CellSet dataset, int[] intArray, int veclen, int nData, int coord, int offsetFrom, int offsetTo)
   {
