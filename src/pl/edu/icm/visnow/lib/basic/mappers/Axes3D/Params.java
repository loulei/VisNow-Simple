...
public class Params extends Parameters
{
   ...
   {
      new ParameterEgg(DESCS,     ParameterType.independent, new String[]{"X", "Y", "Z"}),
      new ParameterEgg(FORMATS,   ParameterType.independent, new String[]{"%4.1f", "%4.1f", "%4.1f"}),
      new ParameterEgg(GRID,      ParameterType.independent, new boolean[]{true, true, true}),
      new ParameterEgg(POSITION,  ParameterType.independent, 
                                new int[][]{{MIN, MIN}, {MIN, MIN}, {MIN, MIN}}),
      new ParameterEgg(BOX,       ParameterType.independent, true),
      new ParameterEgg(DENSITY,   ParameterType.independent, 600)
   };
