   ...
   public VolumeRenderer(boolean lendUI)
   {
      ...
      dataMappingParams.addRenderEventListener(new RenderEventListener()
      {
         ...
         public void renderExtentChanged(RenderEvent e)
         {
            ...
            {
//               colormapLegend.getParams().setColormap(dataMappingParams.getColorMap0Params().getMapType());
               colormapLegend.getParams().setColorMapLookup(dataMappingParams.getColorMap0Params().getARGBColorTable());
    ...
    public void onActive()
   {
      ...
      if (in == null)
      {
         //MainWindow.getInfoFrame().showInfo(500, 500, getName(), "empty input data");
         inField = null;
         outObj.clearAllGeometry();
         volRender = null;
         return;
      }
      if (in.getDims().length != 3)
      {
         //MainWindow.getInfoFrame().showInfo(500, 500, getName(), "<html> input field has "+in.getDims().length+" dimension(s)<p>"+"only 3-dimensional fields are supported");
         inField = null;
         //outObj.clearAllGeometry();
         volRender = null;
         return;
      ...
      if (in.isCoords())
      {
         //MainWindow.getInfoFrame().showInfo(500, 500, getName(), "<html> input field has explicit coordinates<p>"+"only affine fields are supported");
         inField = null;
         //outObj.clearAllGeometry();
         volRender = null;
         return;
...
//
    ...
    */
   protected transient ArrayList<FieldPickListener> fieldPickListenerList
           = new ArrayList<FieldPickListener>();
