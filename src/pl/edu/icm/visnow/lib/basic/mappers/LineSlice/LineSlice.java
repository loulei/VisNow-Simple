...
import pl.edu.icm.visnow.lib.templates.visualization.modules.RegularOutField1DVisualizationModule;
 ...
 */
public class LineSlice extends RegularOutField1DVisualizationModule
{
   ...
   public void update()
   {
      ...
      outField.setAffine(sliceAffine);
