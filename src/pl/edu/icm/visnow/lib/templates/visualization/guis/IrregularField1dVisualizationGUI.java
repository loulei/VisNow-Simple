 ...
 */
//TODO: apparently this class is no longer used (remove it?)
@Deprecated
public class IrregularField1dVisualizationGUI extends javax.swing.JPanel {

    /** Creates new form IrregularField1dVisualizationGUI */
    public IrregularField1dVisualizationGUI() {
        initComponents();
   ...
   {//GEN-HEADEREND:event_guiPresentationButtonStateChanged
      presentationPanel.setPresentation(guiPresentationButton.getState() == 1);
      fireStateChanged();
