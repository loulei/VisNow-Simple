...
import pl.edu.icm.visnow.geometries.gui.Presentation1DPanel;
 ...
 */
public class Field1dVisualizationGUI extends javax.swing.JPanel {

    /** Creates new form Field1dVisualizationGUI */
    public Field1dVisualizationGUI() {
        initComponents();
    }
   ...
   private void initComponents()
   {
      ...
      presentationPanel = new pl.edu.icm.visnow.geometries.gui.Presentation1DPanel();
      guiPresentationButton = new MultistateButton(new String[]{"show simple GUI","show expert GUI"}, null);

      setMinimumSize(new java.awt.Dimension(185, 588));
      setPreferredSize(new java.awt.Dimension(225, 608));
      setLayout(new java.awt.BorderLayout());

      mainPane.setName("mainPane"); // NOI18N

      presentationPanel.setMinimumSize(new java.awt.Dimension(180, 550));
      presentationPanel.setName("presentationPanel"); // NOI18N
      presentationPanel.setPreferredSize(new java.awt.Dimension(220, 550));
   ...
   public Presentation1DPanel getPresentation1DPanel()
   {
   ...
   public boolean isAdjusting() {
       return presentationPanel.isAdjusting();
   }
 
   // Variables declaration - do not modify//GEN-BEGIN:variables
   private pl.edu.icm.visnow.gui.widgets.MultistateButton guiPresentationButton;
   private javax.swing.JTabbedPane mainPane;
   private pl.edu.icm.visnow.geometries.gui.Presentation1DPanel presentationPanel;
   // End of variables declaration//GEN-END:variables

    public pl.edu.icm.visnow.geometries.gui.Presentation1DPanel getPresentationPanel() {
        return presentationPanel;
    }
